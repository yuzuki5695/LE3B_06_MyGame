...
namespace MyGame {
    ...
    private: // メンバ変数
        ...
        std::vector<MyEngine::Vector2> panelTargetPos_;
        ...
        MyEngine::Vector2 commandOffset_[kMaxCommand];
        int commandPanelIndex_[kMaxCommand];
        MyEngine::Vector2 commandStart_[kMaxCommand];
        MyEngine::Vector2 commandEnd_[kMaxCommand];
        // 配置用定数
